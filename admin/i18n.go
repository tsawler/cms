...
var frStrings = map[string]string{
	...
	"Upload":                             "Téléverser",
	"Images (JPEG, PNG, GIF, WebP — resized automatically), videos (MP4, WebM — stored as uploaded), PDFs, office documents, text/CSV, or ZIP.": "Images (JPEG, PNG, GIF, WebP — redimensionnées automatiquement), vidéos (MP4, WebM — conservées telles quelles), PDF, documents bureautiques, texte/CSV ou ZIP.",
