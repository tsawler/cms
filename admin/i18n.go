...
var frStrings = map[string]string{
	...
	"This is the address you log in with.":      "C'est l'adresse avec laquelle vous vous connectez.",
	"(needed only to change your email)":        "(requis seulement pour changer votre courriel)",
	...
	"Enter your password to change your email.": "Entrez votre mot de passe pour changer votre courriel.",
	...
	"Delete this user? Their posts and uploads remain but lose their author. This cannot be undone.": "Supprimer cet utilisateur ? Ses billets et téléversements restent mais perdent leur auteur. Cette action est irréversible.",
	...
	"Private pages stay hidden from visitors who aren't logged in, even when published.": "Les pages privées restent cachées des visiteurs non connectés, même une fois publiées.",
	...
	"This image also starts the banner at the top of the post — open the post on the site to restyle or remove it.": "Cette image sert aussi de point de départ à la bannière en haut du billet — ouvrez le billet sur le site pour la restyler ou la retirer.",
	...
	"{name} saved to your downloads.":             "{name} a été enregistré dans vos téléchargements.",
	"Downloading {name} — see your browser's downloads.":                  "Téléchargement de {name} — voyez les téléchargements de votre navigateur.",
	"That file could not be downloaded.":                                  "Ce fichier n'a pas pu être téléchargé.",
	"Downloading {n} files…":                                              "Téléchargement de {n} fichiers…",
	"{n} files saved to your downloads.":                                  "{n} fichiers ont été enregistrés dans vos téléchargements.",
	"Those files could not be downloaded.":                                "Ces fichiers n'ont pas pu être téléchargés.",
	"Copied!":                                                             "Copié!",
	...
	// Media browser chrome and the upload dialog.
	...
	"Drop files here, or choose files": "Déposez des fichiers ici, ou choisissez des fichiers",
	"Uploading — {done} of {total}":    "Téléversement — {done} sur {total}",
	"Upload complete":                  "Téléversement terminé",
	"Finished — {failed} could not be uploaded": "Terminé — {failed} n'ont pas pu être téléversés",
	"Queued":                   "En attente",
	"Failed":                   "Échec",
	"Canceled":                 "Annulé",
	"Upload failed.":           "Le téléversement a échoué.",
	"saved outside the folder": "enregistré hors du dossier",
	"Uploaded, but saved outside the folder — that folder holds a different kind of file.": "Téléversé, mais enregistré hors du dossier — ce dossier contient un autre type de fichier.",

	// Listing, selection bar and inspector.
	"Dimensions":              "Dimensions",
	"Added":                   "Ajouté",
	"Details":                 "Détails",
	"no alt":                  "sans texte alt",
	"Move to":                 "Déplacer vers",
	"Move to…":                "Déplacer vers…",
	"Move out of this folder": "Sortir de ce dossier",
	"1 selected":              "1 sélectionné",
	"{n} selected":            "{n} sélectionnés",
	"1 file moved.":           "1 fichier déplacé.",
	"%d files moved.":         "%d fichiers déplacés.",
	"1 file deleted.":         "1 fichier supprimé.",
	"%d files deleted.":       "%d fichiers supprimés.",
	"Delete the selected files? Pages still using them will break.":        "Supprimer les fichiers sélectionnés? Les pages qui les utilisent encore seront brisées.",
	"Select one file to see its details.":                                  "Sélectionnez un fichier pour voir ses détails.",
	"Screen readers read this instead of the picture.":                     "Les lecteurs d'écran lisent ceci à la place de l'image.",
	"Nothing matches that search.":                                         "Aucun résultat pour cette recherche.",
	"No images here yet. Drop files on this page, or use Upload.":          "Aucune image ici pour l'instant. Déposez des fichiers sur cette page, ou utilisez Téléverser.",
	"No documents here yet. Drop files on this page, or use Upload.":       "Aucun document ici pour l'instant. Déposez des fichiers sur cette page, ou utilisez Téléverser.",
	"No videos here yet. Drop an MP4 or WebM on this page, or use Upload.": "Aucune vidéo ici pour l'instant. Déposez un MP4 ou un WebM sur cette page, ou utilisez Téléverser.",
	...
	"Move or delete its files first — this folder isn't empty.": "Déplacez ou supprimez d'abord ses fichiers — ce dossier n'est pas vide.",
	...
	"Duplicating the page failed — try again.": "La duplication de la page a échoué — réessayez.",
	"Posts can't be duplicated.":               "Les articles ne peuvent pas être dupliqués.",
	...
	"Custom links need a web address like https://…, a path like /contact, or an anchor like #pricing.": "Les liens personnalisés ont besoin d'une adresse web comme https://…, d'un chemin comme /contact ou d'une ancre comme #pricing.",
