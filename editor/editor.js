...
(() => {
  ...
  function openCodePanel(scope) {
    ...
    $("code-hint").textContent = (site ? "Every public page. Enter plain code \u2014 no <style> or <script> tags; " : "This page only. Enter plain code \u2014 no <style> or <script> tags; ") + "CSS goes into <head>, JavaScript runs before </body>.";
    ...
    var load = site ? api("/settings").then(function(s) {
      return {
        css: s.siteCss,
        js: s.siteJs,
        cssLinks: s.siteCssLinks,
        jsLinks: s.siteJsLinks
      };
